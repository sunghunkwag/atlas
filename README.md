...
APEX (Algebraic Partition-based EXploration) extends the framework with Walsh-basis landscape analysis and structure-aware local search:
...
- **Importance-weighted perturbation** — ILS perturbation that preferentially flips low-importance variables, preserving CD-optimized high-importance structure during basin transitions.

### Benchmark (NK Landscape, N=14, K=7, O=5)

| Budget | REA | PAR | FLAS | ATLAS | NEXUS | APEX |
|--------|-----|-----|------|-------|-------|------|
| B=100  | 73.8 | 76.2 | 73.3 | 76.0 | 72.7 | 72.7 |
| B=200  | 75.6 | 76.3 | 74.8 | 76.3 | 75.8 | 75.8 |
| B=300  | 76.3 | 75.7 | 75.3 | 75.0 | 76.9 | 77.0 |
| B=500  | 76.3 | 75.8 | 76.5 | 74.4 | 78.3 | 78.0 |
| B=750  | 77.5 | 76.0 | 76.2 | 74.9 | 78.9 | 79.0 |

Aggregate over 5 NK instances × 32 seeds (160 paired observations per budget level). APEX matches NEXUS performance across all budgets (paired Wilcoxon signed-rank p > 0.05 at all budget levels). The importance-weighted perturbation shows instance-dependent improvements at B ≥ 750 (d = +0.04 to +0.39 depending on instance).
...
**APEX** — Walsh-basis structure analysis with importance-weighted ILS. Provides complementary analytical tools (VIG, partition crossover) alongside competitive search performance.
